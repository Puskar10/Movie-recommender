  ...
  if (movies.length === 0) {
    return (
      <div className="w-full py-16 flex flex-col items-center justify-center text-center">
        ...
        <h3 className="text-lg font-bold text-slate-850 dark:text-slate-150">No Movies Found</h3>
        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1 max-w-sm">
          We couldn't find any movies matching your current filters. Try searching for something else or changing genres.
        </p>
      </div>
    );
  }
